  ...
  return (
    <div className='flex item-center justify-between max-sm:flex-col-reverse gap-y-10 px-4 mt-10 lg:px-44 sm:mt-20'>
        ...
        <div >
            ...
            <p className='my-6 text-[15px] text-gray-500'>Say goodbye to distracting backgrounds! Focus on what matters and elevate your photos instantly <br  className='max-sm:hidden' /> Perfect cutouts, just a click away!.</p>
            <div>
